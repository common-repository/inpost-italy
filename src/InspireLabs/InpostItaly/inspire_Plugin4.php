...
abstract class inspire_Plugin4 {
	...
	public function initBaseVariables() {
		...
		// Set Plugin Path
		$this->_pluginPath     = dirname( INPOST_ITALY_PLUGIN_FILE );
		$this->_pluginFullPath = plugin_dir_path( INPOST_ITALY_PLUGIN_FILE );

		// Set Plugin URL
		$this->_pluginUrl    = plugin_dir_url( INPOST_ITALY_PLUGIN_FILE );
		...
		$this->_pluginFilePath = basename( INPOST_ITALY_PLUGIN_FILE );
